...
/*
   ...
   and will be responsible for calling other composables
   that make up the UI
*/
@Composable
fun DessertScreen(
    ...
    // adjust our code so that it refers to
    // dessertUiState val we made in DessertScreen
    // this becomes the body of DessertScreen composable
    Scaffold(
        topBar = {
